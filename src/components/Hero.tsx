        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left" ref={parallaxRef}>
            ...
            <div className="mb-6 flex justify-center lg:justify-start">
              <img src={theme === "dark" ? "/lovable-uploads/2ca713b7-50da-4fb6-a136-fef41f5753fe.png" : "/lovable-uploads/ec511a56-2208-4121-9167-87e2e512a9c4.png"} alt="ForenLock Logo" className="h-28 transition-all duration-300" />
            </div>
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <img alt="ForenLock Research Concept" src="/lovable-uploads/a62a5bc3-30ba-4c34-b08a-1bc436e6f518.png" className="relative z-10 w-full max-w-md rounded-xl shadow-xl dark:shadow-navy-900/50 transition-all duration-300 hover:scale-105 object-fill" />
            </div>
          </div>
        </div>
      </div>
