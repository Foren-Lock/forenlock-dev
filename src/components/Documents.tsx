...
const documents = [
  ...
  { 
    ...
    icon: FileText,
    description: "Technical Assessment Framework documenting technology choices.",
    url: "https://drive.google.com/file/d/1Hev2ak9JZtjWAtNUEiuxwxM4x-1KHsfm/view?usp=sharing"
  },
  { 
    title: "Proposal Report | Individual", 
    icon: FileSpreadsheet,
    description: "Comprehensive research proposal with literature review.",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {documents.map((document, index) => {
            ...
            return (
              <div 
                key={index} 
                className="bg-navy-50 rounded-lg p-6 border border-navy-100 shadow-sm hover:shadow-md transition-shadow"
              >
